<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Shopping_Mall.Registration" %>
        ...
        <table style="border:1px solid black">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorUserName" runat="server" ErrorMessage="Username is required" ForeColor="Red" ControlToValidate="txtUserName" Text="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorPassword" runat="server" ErrorMessage="Password is required" ForeColor="Red" ControlToValidate="txtPassword" Text="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
